...
echo "INSTALL_CP4I=$INSTALL_CP4I"
...
cat $SCRIPT_DIR/setupResources/mq-operator-subscription.yaml_template |
  sed "s#{{NAMESPACE}}#$namespace#g;" > $SCRIPT_DIR/setupResources/mq-operator-subscription.yaml

oc apply -f $SCRIPT_DIR/setupResources/mq-operator-subscription.yaml

rm $SCRIPT_DIR/setupResources/mq-operator-subscription.yaml

wait_for_operator_start ibm-mq  $namespace

echo "Completed installation of API Connect, App Connect and IBM MQ operators successfully"